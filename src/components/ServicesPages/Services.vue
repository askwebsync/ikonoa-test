<template>
  <div class="container mx-auto px-4 py-12 md:px-8 lg:p-24">
    <div class="flex flex-col px-4 gap-10 md:gap-12">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
        <router-link :to="{ name: 'risk-consulting' }">
          ...
          >
            <div
              class="flex flex-col gap-7 md:gap-10 px-5 py-8 md:px-7 text-center md:h-72 xl:h-64"
            >
              <h1
              ...
              <p class="text-sm leading-tight md:text-base xl:text-lg">
